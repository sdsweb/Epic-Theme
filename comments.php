		...
		<?php if ( have_comments() ) : ?>
			<section class="comments-title-container cf">
				<h4 class="comments-title block-title">
					<?php
						printf( _n( 'One thought on &ldquo;%2$s&rdquo;', '%1$s thoughts on &ldquo;%2$s&rdquo;', get_comments_number(), 'epic' ),
			...
			<?php if ( get_comment_pages_count() > 1 && get_option( 'page_comments' ) ) : // Are there comments to navigate through? ?>
				<nav class="navigation comment-navigation" role="navigation">
					<h1 class="assistive-text section-heading"><?php _e( 'Comment navigation', 'epic' ); ?></h1>
					<section class="nav-previous"><?php previous_comments_link( __( '&larr; Older Comments', 'epic' ) ); ?></section>
					<section class="nav-next"><?php next_comments_link( __( 'Newer Comments &rarr;', 'epic' ) ); ?></section>
				</nav>
