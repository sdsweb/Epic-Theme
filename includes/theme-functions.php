...
if ( ! function_exists( 'sds_archive_title' ) ) {
	function sds_archive_title() {
		...
		?>
			<h1 title="<?php esc_attr_e( 'Author Archive:', 'epic' ); ?> <?php echo ( $author instanceof WP_User ) ? $author->display_name : false; ?>" class="page-title">
		...
		elseif ( is_category() ) :
		?>
			<h1 title="<?php single_cat_title( __( 'Category Archive: ', 'epic' ) ); ?>" class="page-title">
		...
		elseif ( is_tag() ) :
		?>
			<h1 title="<?php single_tag_title( __( 'Tag Archive: ', 'epic' ) ); ?>" class="page-title">
		...
		?>
			<h1 title="<?php esc_attr_e( 'Daily Archives:', 'epic' ); ?> <?php echo $the_date; ?>" class="page-title">
		...
		?>
			<h1 title="<?php esc_attr_e( 'Monthly Archives:', 'epic' ); ?> <?php echo $the_date; ?>" class="page-title">
		...
		?>
			<h1 title="<?php esc_attr_e( 'Yearly Archives:', 'epic' ); ?> <?php echo $the_date; ?>" class="page-title">
