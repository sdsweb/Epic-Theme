	...
	<section class="content-wrapper 404-content">
		<article class="content">
			<header class="404-title">
				<h1 title="404 Error" class="page-title"><?php _e( '404 Error', 'epic' ); ?></h1>
			</header>

			<section class="404-error no-posts latest-post">
				<p><?php _e( 'We apologize but something when wrong while trying to find what you were looking for. Please use the navigation below to navigate to your destination.', 'epic' ); ?></p>

				<section id="search-again" class="search-again search-block no-posts no-search-results">
					<p><?php _e( 'Search:', 'epic' ); ?></p>
