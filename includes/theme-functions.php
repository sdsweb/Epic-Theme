...
?>
	<div class="updated" style="background-color: #5f87af; border-color: #354f6b; color:#fff;">
		<p><?php printf( __( 'Thank you for activating %1$s! Looking to modify this theme outside of the Theme Options provided? Check our our <a href="%2$s" style="color:#fff; text-decoration: underline;">"One-Click" Child Themes</a>!', 'epic' ), $sds_theme->get( 'Name' ), admin_url( 'themes.php?page=sds-theme-options#one-click-child-themes' ) ); ?></p>
	</div>
<?php
